...
enum BrandMark {
    ...
    /// The mark's own color, or nil when it takes the caller's tint.
    static func brandTint(for harness: String) -> UIColor? {
        switch harness {
        case "claude-code", "mock": return UIColor(hex: 0xD97757)
        default: return nil
        }
    }
}
