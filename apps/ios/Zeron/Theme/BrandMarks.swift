...
enum BrandMark {
    case claude, openai, cursor, devin, droid, grok, hermes, pi, opencode
    ...
    var viewBox: CGSize {
        ...
        case .droid: return CGSize(width: 24, height: 24)
    ...
    var evenOddFill: Bool {
        switch self {
        case .droid, .hermes, .pi, .opencode: return true
    ...
    var pathData: String {
        ...
        case .droid:
            return "M12 2L21.5 7.5v9L12 22 2.5 16.5v-9L12 2zm0 3.2L5.8 8.7v6.6L12 18.8l6.2-3.5V8.7L12 5.2z"
        case .grok:
    ...
    static func brandTint(for harness: String) -> Color? {
        ...
        default: return nil  // codex/cursor/devin/droid/grok/hermes/pi are monochrome marks
        }
    }
}
